...
public class ArrivedFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ArrivingThing[] arrivingThings = {new ArrivingThing("2", R.drawable.coporation1, "顺风", "1234567980", "2015-04-24 1:00pm", "暂未评论", false),
                new ArrivingThing("2", R.drawable.coporation2, "中通", "1234567980", "2015-04-24 2:00pm", "真垃圾！", true)};
